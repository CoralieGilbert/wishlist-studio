...
-- Chaque analyse IA d'une tenue est sauvegardée (avis + suggestions
-- d'ajout/retrait ancrées dans de vrais uid, en jsonb) pour réapparaître
-- dans un carrousel d'historique propre à cette tenue.
